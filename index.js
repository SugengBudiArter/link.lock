  ...
  if (window.location.hash) {
    ...
    unlockButton.addEventListener("click", async () => {
      ...
      try {
        ...
        error("Password Salah Silahkan Coba Lagi Atau Hubungi Pembuat Link (Jika Terjadi Miss Password).");

        // Set the "decrypt without redirect" URL appropriately
        document.querySelector("#no-redirect").href =
          `https://github.com/SugengBudiArter/link.lock/decrypt/#${hash}`;

        // Set the "create hidden bookmark" URL appropriately
        document.querySelector("#hidden").href =
          `https://github.com/SugengBudiArter/link.lock/hidden/#${hash}`;
        return;
      }
